...
def plot_tuples_best_models(df, df_best_models, tuples, colors = ['black', 'red'], folder = '', max_x = 0, titles = [], labels = [], **kwargs):
    ...
    for i,T in enumerate(tuples):
        ...
        for j, (test, color) in enumerate(zip(T, colors)):
            ...
            fit_me(X, Y, n_components = n_components, period = period, name = name, save_to = "", plot_residuals = False, hold=True, color = color, **kwargs)
